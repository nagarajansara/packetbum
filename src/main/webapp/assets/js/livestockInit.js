            	...
            	html+="</ul>";
            	  ...
            	  $("#doneID").click(function(){
            		...
            		var description=$("#descriptionID").val();
                      ...
                      var breed=$("#breedID").val(); 
                  	
                          if(description!=''&&height!=''&&width!=''&&dimension!=''&&weight!=''&&Quantity!=''&&breed!='') {
                        	  resean="";
                          }else{
                        	  resean="Enter All Values";
                          }
                  	...
                  	//	var dymensionCal="<li>"+length+dimension+" X "+height+dimension+" X "+width+dimension+"</li><li>"+weight+weight_type+", No's Pet:"+Quantity+"</li>";
                  		
                  		addItem+="<h4>Item "+counter+"</h4>";
                  		addItem+="<div class='item_fur'>";
                  		addItem+="<ul><li>"+description+"</li><li>"+length+dimension+" X "+height+dimension+" X "+width+dimension+"</li><li>"+weight+weight_type+",No's Pet:"+Quantity+"</li></ul>";
                  		...
                  		var formVal="";
                  			...
                  			formVal+="<input type='hidden' id='breed_"+counter+"' name='breed_"+counter+"' value='"+breed+"'/>";
                  		...
                  		$("#editItem_"+counter).on("click",function(event){
                  			...
                  			$("#breedID").val($("#breed_"+editItem).val());
            		  ...
            		  /*  $("#description_"+editItem).val($("#descriptionID").val());
                		...
                		$("#itemDetailID").append(addItem);
                 		...
                 		var formVal="";
                 			...
                 			formVal+="<input type='hidden' id='breed_"+editItem+"' name='breed_"+editItem+"' value='"+breed+"'/>";
                 		...
                 		$("#editItem_"+editItem).on("click",function(event){
                 			...
                 			$("#breedID").val($("#breed_"+editItem1).val());
