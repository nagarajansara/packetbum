<style>
.btn_logoutSL{
	background: url("../assets/img/loginSL.png");
	width: 80px;
	height: 26px;
	text-indent: -9999px;
	}
  ...
  <option value="index.html?language=sl">SL</option>
            ...
            <div class="menu">            
              <nav>
                    ...
                    <li><a href="listitem.html?search=false"><@spring.message "label.searchdelivery" /></a></li>
            	...
            	<div class="ser_content_bg">
            		<div class="container">
                    	<div class="viewrsDashboard">
                       	  <ul>
                          	<li><a href="index.html" class="btn_setting"><@spring.message "label.prohome.setting" /></a></li>
                            <li><a href="#">${model["usershortname"]}</a></li>
                          </ul>
                        </div> 
