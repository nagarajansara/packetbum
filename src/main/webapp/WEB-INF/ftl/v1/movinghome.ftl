            ...
            <div class="txt_area">
                ...
                <div class="scale_dim">
                    ...
                    <div class="weight">
                            	...
                            	<label style="float:left;padding-right:10px;">Rooms</label>
                                <input type="text" class="size" name="room" id="roomID" placeholder="0"/>
              ...
              <div  id="displayImage" style="display:none">
               ...
               <script src="assets/js/homeItemInit.js" type="text/javascript"></script>
                <script>
