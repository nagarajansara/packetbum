            ...
            <div class="txt_area">
       		  		<textarea placeholder="<@spring.message 'label.getquote.description' />" name="description" id="descriptionID"></textarea>
       		  		 <div>
                    <!-- 	<p>Add Photos (Optional)</p> <a class="btn_images" id="showimageID">VIEW IMAGES</a> -->
           ...
           <div class="scale_dim">
                    ...
                    <div class="weight">
                            	...
                            	<label><@spring.message 'label.getquote.quantity' /></label>
                ...
                <div class="btns">
                   ...
                   <input type="button" id="btn_cancelID"  class="btn_cancel <@spring.message 'label.getquote.cancel' />" />
                    ...
                    <input type="hidden" value="1" id="numForms" name="numForms"/>
                      <input type="hidden" value="1" id="subcategory" name="subcategory"/>
              ...
              <script src="assets/js/jquery.customSelect.js" type="text/javascript"></script>
               <script src="assets/js/generalItemInit.js" type="text/javascript"></script>
                <script>
