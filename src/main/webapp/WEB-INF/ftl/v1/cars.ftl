   <div id="errorMessageSection"></div>
                 ...
                 <div class="scale_dim">
                	<div class="dim_size">
                    	<div class="volume">
                    		 ...
                    		 <label><@spring.message 'label.getquote.carmake' /></label>
                                 <input type="text" class="carmake" id="carmakeID" name="make" style="height:23px;margin-bottom:7px;"/> 
                                 <br>
                                 
                                   <label><@spring.message 'label.getquote.carmodel' /></label>
                    ...
                    <div class="weight">
                                           ...
                                           <p><@spring.message 'label.getquote.cardesc' /></p>
                ...
                <div class="btns">
                  ...
                  <script src="assets/js/carInit.js" type="text/javascript"></script>
              <script>
