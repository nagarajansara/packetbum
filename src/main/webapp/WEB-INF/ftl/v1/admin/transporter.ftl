                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          <#list model["retrieveTransporter"] as retrieveTransporter>
                                            <tr>
                                                <td>${retrieveTransporter.shortname}</td>
                                                <td>${retrieveTransporter.username}</td>
                                                  <td>${retrieveTransporter.mobile}</td>
